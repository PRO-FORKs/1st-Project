label common_day1:
    ...
    show friend_fullbody_default at fullbody_fit
    with dissolve
...
label common_day2:
    ...
    show older_fullbody_default at fullbody_fit
    with dissolve
...
label common_day3:
    ...
    show junior_fullbody_default at fullbody_fit
    with dissolve
    junior "선배."
    p "...나 부른 거야?"
    junior "네. 저 기억 안 나세요?"
